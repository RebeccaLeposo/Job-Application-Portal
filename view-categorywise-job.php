...
<head>
  ...
  <title>PataKazi || Categorywise Work</title>
                      ...
                      foreach ($results as $row) {               ?>
                        ...
                        <div class="box">
                          ...
                          <div class="text-col">
                            ...
                            <a href="jobs-details.php?jobid=<?php echo ($row->jobId); ?>" class="text">Location: <?php echo htmlentities($row->jobLocation); ?></a></br> <a href="#" class="text">Registered Date: <?php echo htmlentities($row->postinDate); ?> </a>
                          </div>
